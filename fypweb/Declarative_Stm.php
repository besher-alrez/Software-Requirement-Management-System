...
<body>
<div class="viewReq">
<p style="margin-left: 70px; font-size: 30px ; font-weight: bold; font-family:sans-serif; color: #1abc9c;">Requirement ID:<span style="margin-left: 10px;"><?php echo $DeclarativeContent[1][0]["req_id"]; ?></span></p>
...
<hr style=" width:1000px ">
		<p > Declarative ID:<?php echo $DeclarativeContent[1][0]["declarative_id"]; ?>   </p>
		<p>Declarative Name:<?php echo $DeclarativeContent[1][0]["declarative_name"]; ?>    </p>
		<p >Declarative Description:<?php echo $DeclarativeContent[1][0]["declarative_desc"]; ?>  </p>
		<p >complexity:<?php echo $DeclarativeContent[1][0]["complexity"]; ?>   </p>
		<p >Priority:<?php echo $DeclarativeContent[1][0]["priority"]; ?>   </p>
</div>
...
<form method = "POST"  action= "addcommentBackend.php">
		...
		<p><textarea style=" width:300px; height:100px; margin-top:100px;" name="comment" max="470" placeholder="Comment"></textarea></p>
	...
	<p style="margin-top :-110px; margin-right:50px; float:right;">Target Project</p>
		<form  style="margin-top :-100px; float:right;"method = "POST"  action= "importBackend.php">
			...
			<p><input type= "hidden" name="declarative_name" value="<?php echo $DeclarativeContent[1][0]["declarative_name"]; ?> "/></p>
			<p><input type= "hidden" name="declarative_desc" value="<?php echo $DeclarativeContent[1][0]["declarative_desc"]; ?>"/></p>
			<p><input type= "hidden" name="complexity" value="<?php echo $DeclarativeContent[1][0]["complexity"]; ?>"/></p>
			<p><input type= "hidden" name="priority" value="<?php echo $DeclarativeContent[1][0]["priority"]; ?>"/></p>
